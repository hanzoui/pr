...
class RepoEventMonitor {
  ...
  async handleWebhookEvent(event: WEBHOOK_EVENT) {
...
// type WebhookLabelAbleEvent = Pick<GH[`webhook-${string}` & keyof GH], "issue">;

// function handleLabelAbleEvents<T>(event: WEBHOOK_EVENT) {
//   // run every pr/pr-review/issue body/comments added/edited
//   event.issue;
// }
