...
describe("GithubFrontendIssueTransferTask", () => {
  ...
  it("should transfer new frontend issue", async () => {
    ...
    server.use(
      ...
      // Mock listing comments (for comment pagination)
  ...
  it("should handle comment posting errors", async () => {
    ...
    server.use(
      ...
      // Note: No need to mock closing since comment fails and close is in the same try block
    );
  ...
  it.skip("should handle pagination with multiple pages", async () => {
    ...
    server.use(
      ...
      // Mock listing comments for all issues
